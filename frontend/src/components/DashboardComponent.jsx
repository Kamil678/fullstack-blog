...
export default function DashboardComponent() {
  ...
  return (
    <div className="p-3 md:mx-auto">
      <div className="flex flex-wrap gap-4 justify-center">
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            ...
            <LiaComments className="bg-indigo-600  text-white rounded-full text-5xl p-3 shadow-md" />
          </div>
          <div className="flex  gap-2 text-sm">
            <span className="text-green-500 flex items-center">
              <HiArrowNarrowUp />
      ...
      <div className="flex flex-col gap-5 py-7 mx-auto justify-center">
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between p-3 text-sm font-semibold">
            <h1 className="text-center p-2">Ostatni użytkownicy</h1>
            <Button outline gradientDuoTone="cyanToBlue">
              <Link to={"/dashboard?tab=users"}>Zobacz wszystkich</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
        ...
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between  p-3 text-sm font-semibold">
            <h1 className="text-center p-2">Ostatnie artykuły</h1>
            <Button outline gradientDuoTone="cyanToBlue">
              <Link to={"/dashboard?tab=posts"}>Zobacz wszystkie</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
        ...
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between  p-3 text-sm font-semibold">
            <h1 className="text-center p-2">Ostatnie komentarze</h1>
            <Button outline gradientDuoTone="cyanToBlue">
              <Link to={"/dashboard?tab=comments"}>Zobacz wszystkie</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
